...
Rake::Task['requests:update_requests_to_accepted'].invoke if Rails.env.development?
Rake::Task['requests:update_requests_to_completed'].invoke if Rails.env.development?
